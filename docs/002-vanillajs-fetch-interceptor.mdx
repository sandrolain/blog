import { HeadBlock } from "../src/PostComponents.js";
import image from "./assets/kevin-horvat-Pyjp2zmxuLk-unsplash.jpg";
import example from "./002-example.html";

export const title = "A simple fetch() interceptor with VanillaJS";

<HeadBlock title={title} src={image} author={
  <span>Photo by <a href="https://unsplash.com/@hidd3n?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Kevin Horvat</a> on <a href="https://unsplash.com/s/photos/monitors?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>
}></HeadBlock>

The introduction of the **Fetch API** has brought a modern and comprehensive method of making HTTP calls to browsers.
...
<a href={example}>View Live Example</a>
