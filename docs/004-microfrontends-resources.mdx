import { HeadBlock } from "../src/PostComponents";
import image from "./assets/ferenc-almasi-fhAfLtHToCs-unsplash.jpg";
import example from "./002-example.html";

export { image };
export const title = "Micro-Frontends Resources";
export const description = "Articles, Books, Tools about the Micro-Frontends artitecture";

<HeadBlock title={title} src={image} author={
  <span>Photo by <a href="https://unsplash.com/@flowforfrank?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Ferenc Almasi</a> on <a href="https://unsplash.com/s/photos/frontend?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></span>
}></HeadBlock>
