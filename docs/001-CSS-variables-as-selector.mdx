...
import { HeadPhoto } from "../src/PostComponents.js";
import image from "./assets/pankaj-patel-6JVlSdgMacE-unsplash.jpg";
import example from "./001-example.html";

export { image };
export const title = "CSS variable as a responsive selector";
...
<HeadPhoto src={image}>
  <span>Photo by <a href="https://unsplash.com/@pankajpatel?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Pankaj Patel</a> on <a href="https://unsplash.com/s/photos/css?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>
</HeadPhoto>
