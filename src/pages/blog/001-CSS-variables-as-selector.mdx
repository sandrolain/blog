...
import image from "./images/pankaj-patel-6JVlSdgMacE-unsplash.jpg";
export const meta = {
  title: "CSS variable as a responsive selector",
  description: "",
  date: "2020-07-05T18:00:00Z",
  image,
  imageAttribute: <>Photo by <a href="https://unsplash.com/@pankajpatel?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Pankaj Patel</a> on <a href="https://unsplash.com/s/photos/css?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></>
}
