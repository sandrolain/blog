...
import image from "./images/engin-akyurt-bPiuY2ZSlvU-unsplash.jpg";
export const meta = {
  title: "Learning through goals",
  description: "More sophisticated, more skills",
  date: "2021-07-25T13:11:01Z",
  image,
  imageAttribute: <>Photo by <a href="https://unsplash.com/@enginakyurt?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">engin akyurt</a> on <a href="https://unsplash.com/s/photos/target?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></>
};
