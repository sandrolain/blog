...
import image from "./images/alvaro-reyes-qWwpHwip31M-unsplash.jpg";
export const meta = {
  title: "Micro-Frontends Resources",
  description: "Articles, Books, Tools about the Micro-Frontends artitecture",
  date: "2021-05-08T13:13:20Z",
  image,
  imageAttribute: <>Photo by <a href="https://unsplash.com/@flowforfrank?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Ferenc Almasi</a> on <a href="https://unsplash.com/s/photos/frontend?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></>
}
