...
import image from "./images/kevin-horvat-Pyjp2zmxuLk-unsplash.jpg";
export const meta = {
  ...
  image,
  imageAttribute: <>Photo by <a href="https://unsplash.com/@hidd3n?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Kevin Horvat</a> on <a href="https://unsplash.com/s/photos/monitors?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></>
}
...
<Link href="./002-example.html"><a>View Live Example</a></Link>
